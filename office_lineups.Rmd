...
suppressMessages(ggsave("LUO1_RvF_wL.png", path = "Mock Lineups/Office Lineup 1 (pos5)"))
...
lineup_resids_o1 %>%
  ...
  labs(title="Lineup 15, Residuals vs. Fitted",
        x ="Fitted values", y = "Residuals")
suppressMessages(ggsave("LUO1_RvF_woL.png", path = "Mock Lineups/Office Lineup 1 (pos5)"))
...
suppressMessages(ggsave("LUO1_SL_wL.png", path = "Mock Lineups/House Lineup 1 (pos5)"))
...
lineup_resids_o1 %>%
  ...
  labs(title="Lineup 15, Scale-Location",
        x ="Fitted values", y = TeX("$\\sqrt{|standardized\\,\\, residuals|}$"))
suppressMessages(ggsave("LUO1_SL_woL.png", path = "Mock Lineups/Office Lineup 1 (pos5)"))
