...
suppressMessages(ggsave("LUO1_SL_wL.png", path = "Mock Lineups/House Lineup 1 (pos9)"))
...
lineup_resids_o2 %>%
  ...
  labs(title="Lineup 16, Scale-Location",
        x ="Fitted values", y = TeX("$\\sqrt{|standardized\\,\\, residuals|}$"))
suppressMessages(ggsave("LUO2_SL_wL.png", path = "Mock Lineups/House Lineup 2 (pos5)"))
