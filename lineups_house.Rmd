...
lineup_resids_h1 <- lineup(null_lm(house_mod1, method = "boot"), true = aug_samph1, n=9, pos=7)
...
ggsave("LUH1_RvF_wL.png", path = "Mock Lineups/House Lineup 1 (pos7)")
...
lineup_resids_h1 %>%
  ...
  labs(title="Lineup 8, Residuals vs. Fitted",
        x ="Fitted values", y = "Residuals")
ggsave("LUH1_RvF_woL.png", path = "Mock Lineups/House Lineup 1 (pos7)")
...
ggsave("LUH1_SL_wL.png", path = "Mock Lineups/House Lineup 1 (pos7)")
...
lineup_resids_h1 %>%
  ...
  labs(title="Lineup 8, Scale-Location",
        x ="Fitted values", y = TeX("$\\sqrt{|standardized\\,\\, residuals|}$"))
ggsave("LUH1_SL_woL.png", path = "Mock Lineups/House Lineup 1 (pos7)")
