...
# data1 <- data %>%
#   filter(wave %in% c(2)) %>%
#   filter(father_alive %in% c("No")) %>%
#   filter(mother_alive %in% c("No")) %>%
#   filter(country_mod %in% c("Austria")) %>%
#   select(all_of(c(factor_list2, ordered_list2, nonfactor_list2)), "bmi")
# 
...
```{r Sample 1 (SHARE) fig.height=7.5, fig.width=9}
...
lineup_resids1 <- lineup(null_lm(samp_mod1, method = "boot"), true = aug_samp1, n=9)
...
lineup_resids1 %>%
  ...
  geom_smooth(col="red", method = "loess", se=FALSE, size = 0.5) +
  facet_wrap(~ .sample) +
  labs(title="Lineup 1, Residuals vs. Fitted",
        x ="Fitted values", y = "Residuals")
ggsave("LU1_RvF_wL.png", path = "Mock Lineups/Lineup 1 (pos7)")
...
lineup_resids1 %>%
  ...
  labs(title="Lineup 1, Residuals vs. Fitted",
        x ="Fitted values", y = "Residuals")
ggsave("LU1_RvF_woL.png", path = "Mock Lineups/Lineup 1 (pos7)")
...
ggsave("LU1_SL_wL.png", path = "Mock Lineups/Lineup 1 (pos7)")
...
lineup_resids1 %>%
  ...
  labs(title="Lineup 1, Scale-Location",
        x ="Fitted values", y = TeX("$\\sqrt{|standardized\\,\\, residuals|}$"))
ggsave("LU1_SL_woL.png", path = "Mock Lineups/Lineup 1 (pos7)")

# decrypt("fjVX rUnU Rg YthRnRtg TL")
# real plot is no.5
...
lineup_resids2 <- lineup(null_lm(samp_mod2, method = "boot"), true = aug_samp2, n=9)
...
lineup_resids2 %>%
  ...
  labs(title="Lineup 2, Residuals vs. Fitted",
        x ="Fitted values", y = "Residuals")
ggsave("LU2_RvF_wL.png", path = "Mock Lineups/Lineup 2 (pos7)")
...
lineup_resids2 %>%
  ...
  labs(title="Lineup 2, Residuals vs. Fitted",
        x ="Fitted values", y = "Residuals")
ggsave("LU2_RvF_woL.png", path = "Mock Lineups/Lineup 2 (pos7)")
...
lineup_resids2 %>%
  ...
  labs(title="Lineup 2, Scale-Location",
        x ="Fitted values", y = TeX("$\\sqrt{|standardized\\,\\, residuals|}$"))
ggsave("LU2_SL_wL.png", path = "Mock Lineups/Lineup 2 (pos7)")
...
lineup_resids2 %>%
  ...
  labs(title="Lineup 2, Scale-Location",
        x ="Fitted values", y = TeX("$\\sqrt{|standardized\\,\\, residuals|}$"))
ggsave("LU2_SL_woL.png", path = "Mock Lineups/Lineup 2 (pos7)")
...
x3 <- rnorm(250)
y3 <- (0.5*x3-1)*(0.5*x3+1) + rnorm(250, sd = 0.7)
...
lineup_resids3 <- lineup(null_lm(samp_mod3, method = "boot"), true = aug_samp3, n=9)
...
lineup_resids3 %>%
  ...
  labs(title="Lineup 3, Residuals vs. Fitted",
        x ="Fitted values", y = "Residuals")
ggsave("LU3_RvF_wL.png", path = "Mock Lineups/Lineup 3 (pos7)")
...
lineup_resids3 %>%
  ...
  labs(title="Lineup 3, Residuals vs. Fitted",
        x ="Fitted values", y = "Residuals")
ggsave("LU3_RvF_woL.png", path = "Mock Lineups/Lineup 3 (pos7)")
...
lineup_resids3 %>%
  ...
  labs(title="Lineup 3, Scale-Location",
        x ="Fitted values", y = TeX("$\\sqrt{|standardized\\,\\, residuals|}$"))
ggsave("LU3_SL_wL.png", path = "Mock Lineups/Lineup 3 (pos7)")
...
lineup_resids3 %>%
  ...
  labs(title="Lineup 3, Scale-Location",
        x ="Fitted values", y = TeX("$\\sqrt{|standardized\\,\\, residuals|}$"))
ggsave("LU3_SL_woL.png", path = "Mock Lineups/Lineup 3 (pos7)")
...
x4 <- rnorm(250)
y4 <- (0.2*x4+1)*(x4-1)*(-0.2*x4+1)*(-0.2*x4-1) + rnorm(250, sd = 0.8)
...
lineup_resids4 <- lineup(null_lm(samp_mod4, method = "boot"), true = aug_samp4, n=9)
...
lineup_resids4 %>%
  ...
  labs(title="Lineup 4, Residuals vs. Fitted",
        x ="Fitted values", y = "Residuals")
ggsave("LU4_RvF_wL.png", path = "Mock Lineups/Lineup 4 (pos7)")
...
lineup_resids4 %>%
  ...
  labs(title="Lineup 4, Residuals vs. Fitted",
        x ="Fitted values", y = "Residuals")
ggsave("LU4_RvF_woL.png", path = "Mock Lineups/Lineup 4 (pos7)")
...
lineup_resids4 %>%
  ...
  labs(title="Lineup 4, Scale-Location",
        x ="Fitted values", y = TeX("$\\sqrt{|standardized\\,\\, residuals|}$"))
ggsave("LU4_SL_wL.png", path = "Mock Lineups/Lineup 4 (pos7)")
...
lineup_resids4 %>%
  ...
  labs(title="Lineup 4, Scale-Location",
        x ="Fitted values", y = TeX("$\\sqrt{|standardized\\,\\, residuals|}$"))
ggsave("LU4_SL_woL.png", path = "Mock Lineups/Lineup 4 (pos7)")
...
lineup_resids5 <- lineup(null_lm(samp_mod5, method = "boot"), true = aug_samp5, n=9)
...
lineup_resids5 %>%
  ...
  labs(title="Lineup 5, Residuals vs. Fitted",
        x ="Fitted values", y = "Residuals")
ggsave("LU5_RvF_wL.png", path = "Mock Lineups/Lineup 5 (pos7)")
...
lineup_resids5 %>%
  ...
  labs(title="Lineup 5, Residuals vs. Fitted",
        x ="Fitted values", y = "Residuals")
ggsave("LU5_RvF_woL.png", path = "Mock Lineups/Lineup 5 (pos7)")
...
lineup_resids5 %>%
  ...
  labs(title="Lineup 5, Scale-Location",
        x ="Fitted values", y = TeX("$\\sqrt{|standardized\\,\\, residuals|}$"))
ggsave("LU5_SL_wL.png", path = "Mock Lineups/Lineup 5 (pos7)")
...
lineup_resids5 %>%
  ...
  labs(title="Lineup 5, Scale-Location",
        x ="Fitted values", y = TeX("$\\sqrt{|standardized\\,\\, residuals|}$"))
ggsave("LU5_SL_woL.png", path = "Mock Lineups/Lineup 5 (pos7)")
# real plot is no6
```
```{r Sample 6 fig.height=7.5, fig.width=9}
x6 <- rnorm(250)
y6 <- -(0.2*x6-2)^2*(0.25*x6+1)*(x6^2-4) + rnorm(250, sd = 2)
...
lineup_resids6 <- lineup(null_lm(samp_mod6, method = "boot"), true = aug_samp6, n=9)
